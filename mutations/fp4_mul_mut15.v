// Mutation 15 — also direct-route Y[7].
// mag[7] = 1 ⟺ output is ±144 ⟺ both inputs are ±6.
// Under σ=(0,1,2,3,6,7,4,5), val=6 corresponds to code 101 = (a[2]=1,a[1]=0,a[0]=1).
// So mag[7] = a[0]&~a[1]&a[2] AND b[0]&~b[1]&b[2].
// Then y[7] = mag[7] XOR (sy & ~below7).
...
module fp4_mul (
    ...
    // mag[7]: hardcode it as a 6-input AND (raw bits)
    // = a[0] & ~a[1] & a[2] & b[0] & ~b[1] & b[2]
    wire mag7_h = a[0] & ~a[1] & a[2] & b[0] & ~b[1] & b[2];
