// Mutation 28 — explicit el_xor / el_or shared signals
// Hypothesis (from explore agent reading the 65-gate eSLIM output):
// the post-eSLIM netlist exposes shift-mode parity (el_a XOR el_b) early
// and reuses it across product/negate. Naming it as a wire may guide ABC
// toward the same factorization without needing a 900s SAT pass.
...
module fp4_mul (
    ...
    wire el_xor = el_a ^ el_b;
    wire el_or  = el_a | el_b;
