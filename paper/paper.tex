...
\begin{enumerate}
  ...
  \item \textbf{SAT/ILP exact synthesis}: Cirbo CircuitFinderSat confirms the
        ...
        Applying the same technique to the E-sum+decoder (4-in 7-out, currently
        18 gates) may yield further reductions; initial searches at $N=17$ are
        indeterminate at 120\,s budget.
